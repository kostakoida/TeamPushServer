...
public class Path {
	...
	// pages
	public static final String PAGE__TEST = "/WEB-INF/pages/UniversityNotification.html";
	...
	public static final String PAGE__MAIN = "/WEB-INF/pages/main.html";

	// commands
	public static final String COMMAND__TEST = "/universitynotification";
	...
	public static final String COMMAND__MAIN = "/main";
}
